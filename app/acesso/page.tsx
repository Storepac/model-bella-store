...
import { Store, Lock, User, Eye, EyeOff, Shield, ArrowLeft } from "lucide-react"
      ...
      if (data.success) {
        ...
        setTimeout(() => {
          if (data.data.user.tipo === "admin_master") {
            console.log("🔍 Redirecionando admin master para /admin")
            router.push("/admin")
          } else {
            console.log("🔍 Redirecionando lojista para /dashboard")
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
            ...
            <div className="mt-6 pt-6 border-t">
              <div className="text-center text-sm text-muted-foreground">
                ...
                <div className="bg-gray-50 p-3 rounded-md text-left">
                  ...
                  <p>
                    <strong>Loja:</strong> LOJINHA005 / 123
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="text-center text-sm text-muted-foreground">
          <p>
            Não tem uma loja?{" "}
            <Link href="/cadastro" className="text-pink-500 hover:underline">
              Criar conta
            </Link>
          </p>
        </div>
